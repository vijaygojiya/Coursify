    ...
    return (
      <>
        <ImageBackground
          ...
          <LinearGradient
            ...
            <Pressable onPress={navigation.goBack}>
              <Chevron stroke={colors.neutral10} />
            </Pressable>
            <Image source={{uri: thumbnail}} style={styles.thumbnailImg} />
            <View>
              <Text
                numberOfLines={2}
                style={[textVariants.h4, {color: colors.neutral10}]}>
                {title}
              </Text>
              <Text
                numberOfLines={2}
                style={[textVariants.small, {color: colors.neutral40}]}>
                {description}
              </Text>
            </View>
          </LinearGradient>
        ...
        <View style={styles.instructorInfoContainer}>
          ...
          />
          <View>
            <Text style={[textVariants.small, {color: colors.neutral70}]}>
              Instructor
            </Text>
            <Text style={[textVariants.caption, {color: colors.neutral80}]}>
              {instructor.name}
            </Text>
          </View>
